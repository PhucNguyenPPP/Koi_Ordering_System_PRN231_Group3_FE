...
import { Box, Checkbox, Paper, Typography, Button, CircularProgress } from '@mui/material';
        ...
        return (
            <div className={styles.cartPage}>
                <Paper className={styles.section} elevation={3}>
                    <p className='text-center text-red-700 text-3xl font-semibold'>No Koi Found</p>
                </Paper>
            </div>
        );
    }
        ...
        <div className={styles.cartPage}>
            <Paper className={styles.section} elevation={3}>
                <Box display="flex" alignItems="center" padding={1}>
                    ...
                    <Typography variant="h6" style={{ flex: 0.5, textAlign: 'center', fontWeight: 'bold' }}>Action</Typography>
                </Box>
            </Paper>
                ...
                <Paper key={cart.cartId} className={styles.section} elevation={2}>
                    <Box display="flex" alignItems="center" padding={1}>
                        ...
                        <Box display="flex" alignItems="center" flex={2}>
                            <img src={cart.koiAvatar} alt={cart.koiName}
                            ...
                            <Typography
                                style={{
                                    ...
                                    fontSize: '20px',
                                    paddingLeft: '10px'
                                }} variant="body1">{cart.koiName}
                            </Typography>
                        </Box>
                        <Typography variant="body1" style={{ flex: 1, textAlign: 'right' }}>{cart.farmName}</Typography>
                        <Typography variant="body1" style={{ flex: 1, textAlign: 'right', color: '#C71125', fontWeight: 'bold' }}>{formatPriceVND(cart.price)}</Typography>
                        <Box style={{ flex: 0.5, textAlign: 'center' }}>
                            <Button variant="outlined" color="error" onClick={() => handleDelete(cart.cartId)} >Delete</Button>
                        </Box>
                    </Box>
                </Paper>
            ))}
